# E.V.Kashkin_MainWebProject
 ...
 <h3>JQuery</h3>
 <p>JS-библиотека, или фреймворк, <b>JQuery</b> находится в папке с таким же именем в проекте. И добавление этого фреймворка в код происходит как раз из этой папки с помощью кода:<br><br>      <<code>script defer type='text/javascript' src='JQuery/jquery.js'></code><<code>/script</code>><br><br>который находится в голове HTML-кода, к примеру в файле с формой регистрации <b><i>"poetry.php"</i></b>.</p>
